...
const buildRows = (list) =>
    list.map(i => ([
        ...
        // pickup
        i["picked_up"], pct(i["picked_up_percent"]),
        // not pickedUp
        i["not_picked_up"], pct(i["not_picked_up_percent"]),
        i.total_shipments
    ]));
...
const buildTotalRow = (list) => {
    ...
    return [
        ...
        // picked up
        sum(list, "picked_up"),
        calcPercent(sum(list, "picked_up"), grandTotal),
        //  not pickedup
        sum(list, "not_picked_up"),
        calcPercent(sum(list, "not_picked_up"), grandTotal),
...
export const useNewOperationPickupStrikeRate = () => {
