          ...
          <Table className="mb-0 text-black table-hover" style={{ borderColor: "black", color: "black !important" }}>
            ...
            <tbody>
              ...
              <tr className="fw-bold">
                <td colSpan={2} className="text-end" style={{ border: "solid black 1px" }}>
                  Grand Total
                </td>
...
export default InvoicePdfGenerater;