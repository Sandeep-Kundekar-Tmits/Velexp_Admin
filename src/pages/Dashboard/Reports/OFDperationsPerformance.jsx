...
import { GET_ALL_REGION, GET_USER_API, OFD_OPERATIONS_PERFORMANCE, SERVICE_CENTER } from "../../../api";
...
import { useOFDOperationPerformance } from "../../../hooks/useOFDOperationPerformance";
import { conformsTo } from "lodash";
const OFDperationsPerformance = () => {
    // select user option
    ...
    //  first mile report
    const { downloadExcel, loading: FirstMileLoading, error } = useOFDOperationPerformance();
    ...
    const OnCheckClick = async () => {
        try {
            ...
            // API call
            const records = await GetOFDOperationPerformance(OFD_OPERATIONS_PERFORMANCE, payload);
    ...
    return (
        <div className='page-content'>
            <div className="container-fluid">
                <div>
                    <h3 className='pb-3 border-bottom '>OFD Operation Performance (FASR)</h3>
                    ...
                    <div className='mt-1'>
                        {
                            OFDOperationsLoading ? <div style={{ height: "40vh" }} className="container-fluid  d-flex flex-column justify-content-center align-items-center">
                                <GridLoader size={20} />
                                <p className="mt-5 h5">Loading OFD Operation Performance ...</p>
                            </div>
                                :
                                <>
                                    <TableContainer
                                        ...
                                        onDownloadExcle={async () => {
                                            ...
                                            await downloadExcel(OFDOperations, "Ofd_Operation_Performance", {
...
export default OFDperationsPerformance