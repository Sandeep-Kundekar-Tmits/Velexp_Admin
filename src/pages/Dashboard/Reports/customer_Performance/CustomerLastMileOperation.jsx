...
import { GET_ADMIN_BOOKING_DETAILS, GET_CUSTOMER_SERVICE, GET_OPERATION_PERFORMANCE, GET_USER_API, PRODUCT_LIST, SERVICE_CENTER, SPD_OPERATION_PERFORMANCE, GET_ALL_REGION, GET_CUSTOMER_PERFORMANCE_FDSR } from '../../../../api';
...
const CustomerLastMileOperation = () => {
    useEffect(() => {
    ...
    const OnCheckClick = async () => {
        ...
        try {
            ...
            // API call
            const records = await GetBookingList(GET_CUSTOMER_PERFORMANCE_FDSR, payload);
...
export default CustomerLastMileOperation